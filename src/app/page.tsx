...
const I = {
  ...
  moon:(s=14,c="#fbbf24")=><svg width={s} height={s} viewBox="0 0 100 100" style={{animation:"moonSpin 12s linear infinite"}}><defs><radialGradient id="mg" cx="40%" cy="35%" r="50%"><stop offset="0%" stopColor="#f5f5f0"/><stop offset="60%" stopColor="#d4d4cc"/><stop offset="100%" stopColor="#a8a8a0"/></radialGradient><radialGradient id="ms" cx="50%" cy="50%" r="50%"><stop offset="70%" stopColor="transparent"/><stop offset="100%" stopColor="rgba(0,0,0,0.3)"/></radialGradient></defs><circle cx="50" cy="50" r="48" fill="url(#mg)"/><circle cx="30" cy="35" r="8" fill="#c0c0b8" opacity="0.5"/><circle cx="55" cy="25" r="5" fill="#b8b8b0" opacity="0.4"/><circle cx="65" cy="55" r="10" fill="#c0c0b8" opacity="0.35"/><circle cx="40" cy="60" r="6" fill="#b0b0a8" opacity="0.4"/><circle cx="75" cy="35" r="4" fill="#b8b8b0" opacity="0.3"/><circle cx="25" cy="50" r="3" fill="#c0c0b8" opacity="0.3"/><circle cx="50" cy="75" r="7" fill="#b8b8b0" opacity="0.3"/><circle cx="50" cy="50" r="48" fill="url(#ms)"/></svg>,
